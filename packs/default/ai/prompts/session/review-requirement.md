...
Follow project's installed AI instructions. Start with `ai/workflows/requirement-planning.md` to read the requirement workspace and understand the current state.
...
Do not implement fixes unless I explicitly ask. Confirm the issues 1 by 1 with me, and convert the confirmed issues into a new phase (and steps) in the requirement plan. If the issues are not actionable, explain why and suggest a better approach.
